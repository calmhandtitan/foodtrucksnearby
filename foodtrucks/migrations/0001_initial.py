        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('facilitytype', models.CharField(
                    default=b'Truck', max_length=64, null=True, blank=True)),
                ...
                ('fooditems', models.CharField(
                    max_length=512, null=True, blank=True)),
                ('x', models.DecimalField(null=True,
                                          max_digits=12, decimal_places=3, blank=True)),
                ('y', models.DecimalField(null=True,
                                          max_digits=12, decimal_places=3, blank=True)),
                ('latitude', models.DecimalField(db_index=True, null=True,
                                                 max_digits=15, decimal_places=12, blank=True)),
                ('longitude', models.DecimalField(db_index=True,
                                                  null=True, max_digits=15, decimal_places=12, blank=True)),
